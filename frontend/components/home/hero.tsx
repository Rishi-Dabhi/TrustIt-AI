    ...
    <section className="py-20 text-center">
      <h1 className="text-5xl font-bold mb-6">
        ...
        <span className="inline-flex items-center px-3 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 bg-200% animate-gradient">
          AI
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" className="inline pb-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 bg-200% animate-gradient" viewBox="0 0 16 16"> 
